...
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { sw_rectangle }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { sw_square }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=sw[1]
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { sw_green }]; #IO_L6N_T0_D08_VREF_14 Sch=sw[2]
set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { sw_red }]; #IO_L13N_T2_MRCC_14 Sch=sw[3]
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports {  sw_yellow }]; #IO_L12N_T1_MRCC_14 Sch=sw[4]
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports { sw_space  }]; #IO_L7N_T1_D10_14 Sch=sw[5]
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { sw_done  }]; #IO_L17N_T2_A13_D29_14 Sch=sw[6]
...
#set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { decision }]; #IO_L19N_T3_A09_D25_VREF_14 Sch=sw[14]
...
#set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { temp[0] }]; #IO_L14N_T2_SRCC_14 Sch=led[9]
#set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { temp[1] }]; #IO_L22P_T3_A05_D21_14 Sch=led[10]
#set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { temp[2] }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=led[11]
...
##set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports {enable_D2 }]; #IO_L23P_T3_35 Sch=an[6]
##set_property -dict { PACKAGE_PIN U13   IOSTANDARD LVCMOS33 } [get_ports {enable_D2 }]; #IO_L23N_T3_A02_D18_14 Sch=an[7]
...
#set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { slow_button }]; #IO_L9P_T1_DQS_14 Sch=btnc
#set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { fast_button }]; #IO_L4N_T0_D05_14 Sch=btnu
...
set_property -dict { PACKAGE_PIN B2    IOSTANDARD LVCMOS33 } [get_ports { in }]; #IO_L10N_T1_AD15N_35 Sch=ps2_data
